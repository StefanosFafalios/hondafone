    ...
    $(document).ready(function() {        
        $("#loginForm").submit(function(e) {
            if($("#usernameLgnInput").val() == "" || $("#passLgnInput").val() == "") {
                e.preventDefault();
                $("#errorMsg").html("Παρακαλούμε συμπληρώστε και το πεδίο 'Όνομα χρήστη', και το πεδίο 'Κωδικός'!");
            }
        });
    });
</script>
...
<!-- start page -->
<div id="page">
    <p id="errorMsg"><%= request.getParameter("error") != null ? "Σφάλμα κατά τη σύνδεση. Δοκιμάστε ξανά!" : "" %></p>
    <form method="post" action="loginbyWS.jsp" id="loginForm" >
        <table id="lrform">
            <tbody>
                ...
                <tr>
                    <td class="rowtitle">Κωδικός:</td>
                    <td class="rowinput"><input type="password" name="pass" id="passLgnInput" value="" /></td>
                </tr>
                <tr><td colspan="2" id="lrSubTD"><button type="submit" id="lrSub" name="lrSub" >Είσοδος</button></td></tr>
            </tbody>
        </table>
    </form>
</div>
