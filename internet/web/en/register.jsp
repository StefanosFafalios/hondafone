...
<![endif]-->
    ...
    <div id="page">
        <p id="errorMsg">
            <%= request.getParameter("registered") != null ? "You successfully registered to Hondafone. Check your email address for your code" : "" %>
            <%= request.getParameter("error") != null ? "Error while registering. Try again!" : "" %>
            <%= request.getParameter("nomail") != null ? "You successfully registered to Hondafone, but no mail was sent with the password! Please contact us to solve the problem." : "" %>
        </p>
        <form action="registerbyWS.jsp" method="post" id="registerForm">
            <table id="lrform">
                <tbody>
                    ...
                    <tr>
                        <td class="rowtitle"> Birth Date:</td>
                        <td class="rowinput">
                            <select name="bday" id="bday">
                                <option value="00">choose day</option>
                    ...
                    <tr>
                        ...
                        <td class="rowinput">
                            <input class="radio" type="radio" name="genderReg" value="1" id="maleRadio">male&nbsp;&nbsp;
                            <input class="radio" type="radio" name="genderReg" value="0" id="femaleRadio">female
                        </td>
                    </tr>
                    <tr>
                        <td class="rowtitle">Home Address:</td>
                        <td class="rowinput"><input type="text" name="haddReg" id="haddReg"/></td>
                    </tr>
                    <tr>
                        <td class="rowtitle">Work Address:</td>
                        <td class="rowinput"><input type="text" name="waddReg" id="waddReg"/></td>
                    </tr>
                    <tr>
                        <td class="rowtitle">Marital Status:</td>
                        <td class="rowinput">
                            <input class="radio" type="radio" name="marriedReg" value="1" id="marriedRadio">married&nbsp;&nbsp;
                            <input class="radio" type="radio" name="marriedReg" value="0" id="singleRadio">single
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="rowtitle">Bank Account:</td>
